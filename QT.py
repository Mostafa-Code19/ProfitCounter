...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../../Images/crypto2.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label_profitDollar.setGeometry(QtCore.QRect(200, 360, 51, 31))
        font = QtGui.QFont()
        ...
        self.label_profitPercent.setGeometry(QtCore.QRect(130, 360, 51, 31))
        font = QtGui.QFont()
        font.setFamily("Simplified Arabic")
        font.setPointSize(16)
